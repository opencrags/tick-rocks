...
import { useSector, useAuthorizedFetcher, countVotes } from "../utils/backend.js";

export default function VoteSectorName(props) {
  ...
  const navigateToSector = (sectorId) => history.replace(`/crags/${cragId}/sectors/${sectorId}`);
